...
<html lang="en">
    ...
    <body style="background-color: #0d1318">
        ...
        <div class="products-preview" id="wrapper" style="background-color: #0d1318;">
            <div class="preview" data-target="p-1">
                <div class="hover" >
                    <img src="${movie.poster}" alt="img"/>
                    <div class="buttons" >
                        <a class="play" href="video?ID=${movie.id}" style="color: #fff;z-index: 100;" >
                            <i class="bx bx-play-circle"  style="font-size: 200px;position: absolute;top: 20%;left: 20%"></i>
                        </a>

                        <a href="trailer.jsp" class="trailer" style="color: #fff">
                            <i class="bx bx-movie-play "  style="font-size: 100px;font-weight: lighter;position: absolute;bottom: 50%;left: 45%"></i>

                        </a>
                        <a href="addfavorite?ID=${movie.id}&favorite=0&home=0&homead=0"  class="ph" style="color: #fff">
                            <i class="bx bx-heart "  style="font-size: 100px;font-weight: lighter;position: absolute;bottom: 50%;left:  3%"></i>

                            <c:forEach items="${requestScope.listc}" var="id">

                                <c:if test="${movie.id==id}">
                                    
                                    <i class="bx bxs-heart "  style="font-size: 100px;font-weight: lighter;position: absolute;bottom: 50%;left: 3%"></i>
                                </c:if>
                            </c:forEach>
                ...
                <div style="padding-left: 55px;padding-top: 33px">

                    <%--<c:set value="${movie}" var="m">--%>
                    <h2> ${movie.title} <br> <span> <h6>( ${movie.runtime}phút ) - ${movie.view} lượt xem</h6></span></h2>
                    <br><!-- comment -->
                    <p style="width: 777px"> &nbsp;&nbsp;&nbsp;&nbsp; ${movie.overview}</p>
                    <div class="stars" style="position: relative;">
                        <div style="position: absolute;">



                            <c:forEach var="i" begin="0" end="${(movie.vote_average)}" step="1" >
                                <!--${i}-->
                                <c:if test="${i!=0 && i%2==0}">
                                    <!--${i}-->
                                    <i style="color:#ffcc00 " class="fas fa-star s2"></i>
                                ...
                                <c:if test="${i==v&& i%2==1}">
                                    <!--${i}-->
                                    <i style="color:#ffcc00 " class="fa-solid fa-star-half"></i>

                                </c:if>

                            </c:forEach>
                            <!--                            <i style="color:#ffcc00 " class="fas fa-star s2"></i>
                                                        <i style="color:#ffcc00 " class="fas fa-star s4"></i>
                                                        <i style="color:#ffcc00 " class="fas fa-star s6"></i>-->
                        </div>

                        <div style="position: absolute;display: inline">
                            <a href="vote?p=2&ID=${movie.id}"><i class="fa-regular fa-star s0"></i></a>
                            <a href="vote?p=4&ID=${movie.id}"><i class="fa-regular fa-star s0"></i></a>
                            <a href="vote?p=6&ID=${movie.id}"><i class="fa-regular fa-star s0"></i></a>
                            <a href="vote?p=8&ID=${movie.id}"><i class="fa-regular fa-star s0"></i></a>
                            <a href="vote?p=10&ID=${movie.id}"><i class="fa-regular fa-star s0"></i></a>
