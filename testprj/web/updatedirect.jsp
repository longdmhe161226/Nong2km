...
<html lang="en">
    ...
    <body style="background-color: #0d1318">
        ...
        <div class="products-preview" id="wrapper" style="background-color: #0d1318;height: auto;padding-top: 222px;">
            <form action="updatedirect?ID=${dir.id}" method="post">
                <div>Name: &nbsp;&nbsp;&nbsp;&nbsp;<input style="width: 444px;margin-right:289px;height: 33px;" type="text" name="name" value="${dir.fullname}"/>
                    <br><!-- comment -->
                    <br>



                    Description: <textarea id="overv" name="des" rows="5" cols="100" style="height: 155px"  >${dir.description}</textarea>
                    <br><!-- comment -->
                    <br>
                    ...
                    <br><!-- comment -->
                    <br>
                    Dob: <input type="date" name="dob" value="${dir.dob}">
                    <br><!-- comment -->
                    <br>
                    Nationality: <input type="text" id="id" name="Nationality" value="${dir.nationality}">
                    <br><!-- comment -->
                    <br>
