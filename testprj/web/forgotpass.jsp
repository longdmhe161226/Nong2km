    ...
    <body style="background-color: #0d1318">
        ...
        <div class="products-preview" id="wrapper" style="background-color: #0d1318;height: auto;padding-top: 222px;">
            ...
            <form action="changeinfor" method="post">
                <div>
                    Nhập mật khẩu mới :&nbsp;&nbsp;&nbsp;&nbsp;<input  style="width: 444px;height: 33px;border-radius: 7px; " type="password" name="pass" /><!-- comment -->
                    <br><!-- comment -->
                    <br><!-- comment -->
                    Nhập lại mật khẩu  :&nbsp;&nbsp;&nbsp;&nbsp;<input  style="width: 444px;height: 33px;border-radius: 7px; " type="password" name="repass" />
                    <br><!-- comment -->
                    <br><!-- comment -->
