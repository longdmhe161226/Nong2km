        ...
        <div id="wrapper" style="background-color: #0d1318">
            <div class="headline">
                ...
                <div class="addsearch d-flex">
                    <a href="addcate"><i class="fa-sharp fa-solid fa-plus"></i></a>
            ...
            <table border="2" width="333px" height="777px" cellspacing="2" style="margin-left:  777px">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <c:forEach items="${sessionScope.genre}" var="g">
                        <tr>
                            ...
                            <td>${g.name}</td>
                            <td>${g.description}</td>
                            <td ><a style="color: #bebebe" href="deletecate?ID=${g.id}">Dlete</a> <br> <!-- comment -->
                                <a style="color: #bebebe" href="updatecate?ID=${g.id}">Update</a>
                            </td>
