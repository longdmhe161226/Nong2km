    ...
    <body style="background-color: #0d1318">
        ...
        <div id="wrapper" style="background-color: #0d1318">
            <div class="headline">
                ...
                <div class="addsearch d-flex">
                    <a href="add"><i class="fa-sharp fa-solid fa-plus"></i></a>
                    <form action="listad" id="searchad" method="post">

                        <input type="text" name="search" id="txt" placeholder="Tìm phim ở đây :33" required="Nhập đi rồi tìm :<<<" />
                        <button id="search-btn">
                            <i class="fa-solid fa-magnifying-glass"></i></i></button>
                        ...
                        <li>
                            ...
                            <div class="product-item">
                                <div class="product-top">
                                    ...
                                    <a href="update?ID=${m.id}" class="ph" style="color: #cccccc">
                                        <i class="bx bx-edit "  style="font-size: 38px;font-weight: lighter;scale:80%;position: absolute;bottom: 43%;left:25%"></i>

                                    </a>
                                    <a href="delete?ID=${m.id}"  class="ph" style="color: #cccccc">
                                        <i class="bx bxs-trash"  style="font-size: 38px;font-weight: lighter;scale:80%;position: absolute;bottom: 43%;right: 25%"></i>
