    ...
    <body style="background-color: #0d1318">
        ...
        <div class="products-preview" id="wrapper" style="background-color: #0d1318;height: auto;padding-top: 222px;">
            <form action="" >
                ...
                <div style="
                     display: grid;
                     grid-template-columns: fit-content(0px) fit-content(0px) 1fr;
                    ...
                    <span>
                        <a href="auth?ID=${sessionScope.user.id}&type=1">
                    ...
                    <span style="width: 330px;height: max-content;">
                        Email: &nbsp;&nbsp;&nbsp;&nbsp;    
                    </span><!-- comment -->

                    <span>
                        <a href="auth?ID=${sessionScope.user.id}&type=2">
                    ...
                    <span>
                        <a href="auth?ID=${sessionScope.user.id}&type=3">
                    ...
                    <span>
                        <a href="auth?ID=${sessionScope.user.id}&type=4">
                            Đổi mật khẩu ?
