...
<html lang="en">
    ...
    <body style="background-color: #0d1318">
        ...
        <div class="products-preview" id="wrapper" style="background-color: #0d1318;height: 333px;">
            <h2>Bạn đã đăng kí thành công <br> Ấn đây để về trang chủ: <a href="index"><i class="fa-sharp fa-solid fa-house-chimney"></i></a></h2>
        </div>
