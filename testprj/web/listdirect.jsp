        ...
        <div id="wrapper" style="background-color: #0d1318">
            <div class="headline">
                ...
                <div class="addsearch d-flex">
                    <a href="adddirect"><i class="fa-sharp fa-solid fa-plus"></i></a>
            ...
            <table border="2" width="777px"  cellspacing="2" style="margin-left:  555px;">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <c:forEach items="${derect}" var="d">
                        <tr>
                            ...
                            <td>&nbsp;&nbsp;&nbsp;&nbsp;${d.nationality}</td>
                            <td>&nbsp;&nbsp;&nbsp;&nbsp;${d.description}</td>
                            <td ><a style="color: #bebebe" href="deletedirect?ID=${d.id}">Dlete</a> <br> <!-- comment -->
                                <a style="color: #bebebe" href="updatedirect?ID=${d.id}">Update</a>
                            </td>
