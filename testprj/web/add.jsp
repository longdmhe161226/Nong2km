    ...
    <body style="background-color: #0d1318">
        ...
        <div class="products-preview" id="wrapper" style="background-color: #0d1318;height: auto;padding-top: 222px;">
            <form action="add" method="post">
                <div>Title: &nbsp;&nbsp;&nbsp;&nbsp;<input style="width: 444px;margin-right:289px;height: 33px;" type="text" name="title"/>
                    <br><!-- comment -->
                    <br>
                    Overview: <textarea id="overv" name="overview" rows="5" cols="100" style="height: 155px"></textarea>
                    <br><!-- comment -->
                    <br>
                    Poster: &nbsp;&nbsp;&nbsp;&nbsp;<input style="width: 444px;margin-right:303px;height: 33px;" type="text" name="poster"/>
                    <br><!-- comment -->
                    <br><!-- comment -->
                    Backdrop: &nbsp;&nbsp;&nbsp;&nbsp;<input style="width: 444px;margin-right:324px;height: 33px;" type="text" name="backdrop"/>
                    <br><!-- comment -->
                    <br><!-- comment -->
                    Runtime: &nbsp;&nbsp;&nbsp;&nbsp;<input style="width: 444px;margin-right:317px;height: 33px;" type="text" name="runtime"/>
                    <br><!-- comment -->
                    <br><!-- comment -->
                    Video_link: &nbsp;&nbsp;&nbsp;&nbsp;<input style="width: 444px;margin-right:326px;height: 33px;" type="text" name="video_link"/>

                    <br><!-- comment -->
                    <br><!-- comment -->

                    Release_Date:&nbsp;&nbsp;&nbsp;&nbsp;<input style="width: auto;margin-right:660px;height: 33px;" type="date" name="release_date"/>
                    ...
                    <input  style="margin-bottom: 33px;width: 55px;height: 28px;" type="submit" value="ADD"/><!-- comment -->
