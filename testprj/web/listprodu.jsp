        ...
        <div id="wrapper" style="background-color: #0d1318">
            <div class="headline">
                ...
                <div class="addsearch d-flex">
                    <a href="addproducer"><i class="fa-sharp fa-solid fa-plus"></i></a>
            ...
            <table border="2" width="333px"  cellspacing="2" style="margin-left:  777px">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <c:forEach items="${pro}" var="g">
                        <tr>
                            <td>&nbsp;&nbsp;&nbsp;&nbsp;${g.id}&nbsp;&nbsp;&nbsp;&nbsp;</td>
                            <td>${g.name}</td>
                            <td ><a style="color: #bebebe" href="deletepro?ID=${g.id}">Dlete</a> <br> <!-- comment -->
                                <a style="color: #bebebe" href="updatepro?ID=${g.id}">Update</a>
                            </td>
