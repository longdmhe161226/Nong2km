        ...
        <div id="wrapper" style="background-color: #0d1318">
            <div class="headline">
                ...
                <div class="addsearch d-flex">
                    <a href="addstar"><i class="fa-sharp fa-solid fa-plus"></i></a>
                ...
                <tbody>
                    ...
                    <c:forEach items="${stars}" var="d">
                        <tr>
                            ...
                            <td>&nbsp;&nbsp;&nbsp;&nbsp;${d.nationality}</td>
                            <td>&nbsp;&nbsp;&nbsp;&nbsp;${d.description}</td>
                            <td ><a style="color: #bebebe" href="deletestar?ID=${d.id}">Dlete</a> <br> <!-- comment -->
                                <a style="color: #bebebe" href="updatestar?ID=${d.id}">Update</a>
                            </td>
